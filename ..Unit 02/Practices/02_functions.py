...
#     # backwards = ""  # Initialize an empty string to build the reversed string
#     # for char in s:
...
#     """
#     vowels = "aeiou"  # Define vowels inside the function
#     ans = ""  # Initialize an empty string for consonants
#     for char in word:
#         if char not in vowels:  # Check if the character is not a vowel
#             ans += char  # Add consonant to the result
