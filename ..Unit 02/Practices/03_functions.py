...
# # *debug the code: change the print(False) to return False becase its not called and when on console it will print none


# def is_triangularr(n):
#     """n is an int > 0
#     Returns True if n is triangular, i.e. equals a continued
#     summation of natural numbers (1+2+3+...+k)
#     """
...
# # print(is_triangularr(4))  # print False
# # print(is_triangularr(6))  # print True
# # print(is_triangularr(1))  # print True
